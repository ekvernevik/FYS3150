// Programme for numerically solving the one-dimensional Poisson equation using the special algorithm.
...
int main() {
    ...
    for (int i=1; i<=7; i++) {
        ...
        string filename = "p9_output" + to_string(i) + ".txt";
        ofstream ofile;
        ofile.open(filename);
        ...
        // Print elapsed time for simulation with 1e+n steps, where n = 1, 2, 3, ..., 7
